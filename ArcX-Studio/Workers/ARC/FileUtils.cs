...
namespace ArcX_Studio
{
	public class FileUtils
	{
		...
		internal static string smethod_1(string string_0, string string_1, string string_2, string string_3 = "")
		{
			...
			string result = null;
			string_2 = FileUtils.sGetInt16(string_2);
		...
		public static byte[] ReadBytes(global::System.IO.BinaryReader reader, int fieldSize, FileUtils.ByteOrder byteOrder)
		{
		...
		public static uint smethod_6(global::System.IO.BinaryReader reader, FileUtils.ByteOrder byteOrder)
		{
			if (byteOrder == FileUtils.ByteOrder.LittleEndian)
			{
				return (uint)reader.ReadInt32();
			}
            return global::System.BitConverter.ToUInt32(FileUtils.ReadBytes(reader, 4, FileUtils.ByteOrder.BigEndian), 0);
        }

        public static void smethod_7(global::System.IO.BinaryWriter writer, uint value, FileUtils.ByteOrder byteOrder)
		{
		...
		internal static void sWriteStringToStream(string string_0, string string_1)
		{
			if (global::System.IO.File.Exists(string_0))
			{
				...
				{
					FileUtils.sWriteIntToStream(string_1);
				}
